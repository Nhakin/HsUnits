...
Type
  IInterfaceEx = Interface(IInterface)
    ...
    Property This            : IInterfaceEx Read GetThis;    
  ...
  Protected
    ...
    Function GetThis() : IInterfaceEx; Virtual;
    Function GetRefCount() : Integer;
  ...
  Protected
    ...
    Function GetThis() : IInterfaceEx; OverRide;
...
Function TInterfacedObjectEx.GetThis() : IInterfaceEx;
Begin
  Result := Self;
End;
...
Function TInterfaceExImplementor.GetThis() : IInterfaceEx;
Begin
  If Not (Assigned(FOwner) And Supports(FOwner, IInterfaceEx, Result)) Then
    Result := InHerited GetThis();
End;
